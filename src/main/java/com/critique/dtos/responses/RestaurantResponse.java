...
@Schema(description = "Response DTO containing restaurant details", example = """
        {
            "id": "rest123",
            "name": "Tasty Bites",
            "cuisineType": "Italian",
...
public record RestaurantResponse(
        ...
        @Schema(description = "ID of the restaurant owner", example = "user456")
        String ownerId,
        ...
        @Schema(description = "List of photos associated with the restaurant")
