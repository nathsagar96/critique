...
@Schema(
        description = "Request DTO for restaurant search queries",
        example =
                """
        {
            "q": "Italian",
...
public record RestaurantSearchRequest(
        @Schema(description = "Search query text", example = "Italian") String q,
        @Schema(description = "Latitude for location-based search", example = "40.7128") Double latitude,
        @Schema(description = "Longitude for location-based search", example = "-74.0060") Double longitude,
        @Schema(description = "Search radius in kilometers", example = "5.0") Double radius,
        @Schema(description = "Cuisine type filter", example = "Italian") String cuisineType,
